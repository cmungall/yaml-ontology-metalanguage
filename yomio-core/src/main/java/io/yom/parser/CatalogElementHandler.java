...
public class CatalogElementHandler extends DefaultHandler {
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(CatalogElementHandler.class);
    ...
    /**
     * Handle startElement events by looking for 'uri' elements,
     * and their 'name' and 'uri' attributes, and updating 'mappings'.
     * We only handle 'uri' elements, and do not update mappings
    ...
    public void startElement(String uri, String localName,
        ...
        if (parentFolder != null && toString.indexOf(":") < 0) {
            ...
            try {
                ...
                logger.warn("Skipping mapping: {} {} {}",
                        fromString, toString, e);
            }
        } else {
